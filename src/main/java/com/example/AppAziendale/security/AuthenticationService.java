package com.example.AppAziendale.security;
...
public class AuthenticationService {
    ...
    private SimpleMailMessage createConfirmationEmail(String email, String confirmationUrl) {
        ...
        message.setReplyTo("mail@gmail.com"); // a chi rispondo se faccio "rispondi"
        message.setFrom("mail@gmail.com"); // da chi viene la mail
